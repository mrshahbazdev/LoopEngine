                ...
                <ul role="list" class="-mx-2 space-y-1">
                    ...
                    <li>
                        <a href="{{ route('dashboard') }}"
                           class="group flex gap-x-3 rounded-md p-2 text-sm font-semibold {{ request()->routeIs('dashboard') ? 'bg-indigo-800 text-white' : 'text-indigo-200 hover:bg-indigo-800 hover:text-white' }}">
                    ...
                    <li>
                        <a href="{{ route('processes.index') }}"
                           class="group flex gap-x-3 rounded-md p-2 text-sm font-semibold {{ request()->routeIs('processes.*') ? 'bg-indigo-800 text-white' : 'text-indigo-200 hover:bg-indigo-800 hover:text-white' }}">
                            <svg class="h-6 w-6 shrink-0" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                    ...
                    <li>
                        <a href="{{ route('runs.index') }}"
                           class="group flex gap-x-3 rounded-md p-2 text-sm font-semibold {{ request()->routeIs('runs.*') ? 'bg-indigo-800 text-white' : 'text-indigo-200 hover:bg-indigo-800 hover:text-white' }}">
                            <svg class="h-6 w-6 shrink-0" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                    ...
                    <li>
                        <a href="{{ route('team.dashboard') }}"
                           class="group flex gap-x-3 rounded-md p-2 text-sm font-semibold {{ request()->routeIs('team.*') ? 'bg-indigo-800 text-white' : 'text-indigo-200 hover:bg-indigo-800 hover:text-white' }}">
                            <svg class="h-6 w-6 shrink-0" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                ...
                <ul role="list" class="-mx-2 mt-2 space-y-1">
                    <li>
                        <a href="{{ route('admin.analytics') }}"
                           class="group flex gap-x-3 rounded-md p-2 text-sm font-semibold {{ request()->routeIs('admin.analytics') ? 'bg-indigo-800 text-white' : 'text-indigo-200 hover:bg-indigo-800 hover:text-white' }}">
                            <svg class="h-6 w-6 shrink-0" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                    ...
                    <li>
                        <a href="{{ route('admin.audit') }}"
                           class="group flex gap-x-3 rounded-md p-2 text-sm font-semibold {{ request()->routeIs('admin.audit') ? 'bg-indigo-800 text-white' : 'text-indigo-200 hover:bg-indigo-800 hover:text-white' }}">
                            <svg class="h-6 w-6 shrink-0" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                    ...
                    <li>
                        <a href="{{ route('admin.users') }}"
                           class="group flex gap-x-3 rounded-md p-2 text-sm font-semibold {{ request()->routeIs('admin.users') ? 'bg-indigo-800 text-white' : 'text-indigo-200 hover:bg-indigo-800 hover:text-white' }}">
                            <svg class="h-6 w-6 shrink-0" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
